...
export default function ProjectCard({ project }: ProjectCardProps) {
	...
	return (
		<article className="group relative flex flex-col gap-3 p-6 h-full border-2 border-white/20 rounded-2xl bg-white/[2%] overflow-hidden hover:border-teal-300 hover:-translate-y-1 transition-all duration-300">
