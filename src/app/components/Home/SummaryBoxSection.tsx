		...
		<section className="flex justify-center gap-10 md:gap-20 flex-wrap">
			{stats.map((stat, index) => (
				<Reveal key={stat.label} delayMs={index * 100}>
					<div className="w-64 h-24 border-2 border-white/20 rounded-2xl bg-white/[2%] flex-shrink-0 flex items-center justify-center gap-4 px-4 hover:border-teal-300 hover:bg-teal-300/5 hover:-translate-y-1 transition-all duration-300">
