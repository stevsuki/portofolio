...
/**
 * The accent is deliberately a separate axis from light/dark rather than extra
 * entries in next-themes' theme list. A visitor picks a mode, an accent and a
 * background independently, and `resolvedTheme === "dark"` keeps meaning what
 ...
 * truth for one palette. The dot in the picker reads its colour from a
 ...
 */
export const accents: SwatchOption[] = [
	{ id: "teal", label: "Teal" },
	{ id: "blue", label: "Blue" },
...
export const accentSetting = createSwatchSetting({
	storageKey: "portfolio-accent",
	attribute: "accent",
	options: accents,
	fallback: "teal",
});
